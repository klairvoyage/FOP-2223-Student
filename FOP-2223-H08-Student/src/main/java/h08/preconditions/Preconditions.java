...
public class Preconditions {
    ...
    public static void checkPrimaryArrayNotNull(double[][] primaryArray) throws ArrayIsNullException {
        ...
        if (primaryArray==null) throw new ArrayIsNullException();
    }
    ...
    public static void checkSecondaryArraysNotNull(double[][] primaryArray) throws AtIndexException {
        // TODO: H3.1 - remove if implemented
        for (int i=0;i<primaryArray.length;i++) if (primaryArray[i]==null) throw new AtIndexException(i);
    }
    ...
    public static void checkNumberNotNegative(double number) throws WrongNumberException {
        // TODO: H3.1 - remove if implemented
        if (number<0) throw new WrongNumberException(number);
    }
    ...
    public static void checkValuesInRange(double[][] primaryArray, double max) throws AtIndexPairException {
        // TODO: H3.1 - remove if implemented
        for (int i=0;i<primaryArray.length;i++) for (int j=0;j<primaryArray[i].length;j++) if (primaryArray[i][j]<0 || primaryArray[i][j]>max) throw new AtIndexPairException(i, j);
    }
}
