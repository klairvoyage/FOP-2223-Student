...
public class ComposedDoubleBinaryOperator/*TODO: H2.1*/ implements BinaryOperator<Double> {
    ...
    public Double apply(Double left, Double right) {
        ...
        return op3.apply(result1, result2); /*Can result1 & result2 also just be double?*/
    }
}
